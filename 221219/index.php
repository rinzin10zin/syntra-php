...
if (isset($_GET["completed"])) {
    $sql = "UPDATE todo SET completed_at = NOW() WHERE id=" . $_GET["completed"];
    $mysqli->query($sql);
}

// MOET EEN TAAK TEOGEVOEGD WORDEN?
if (isset($_POST["newtask"])) {
    $sql = "INSERT INTO todo(task) VALUES ('" . $_POST["newtask"] . "')";
    $mysqli->query($sql);
}
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="fw-normal">
                                            ...
                                            <td class="align-middle">
                                                <span><?= date("l, j M Y - H:i:s", strtotime($todo["created_at"])) ?></span>
                                            </td>
                                            <td class="align-middle">
                                                ...
                                                <?php } else { ?>
                                                    <span>done <?= get_time_ago(strtotime($todo["completed_at"])) ?></span>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php
